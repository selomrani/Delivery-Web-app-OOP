<aside class="hidden md:flex flex-col w-64 bg-indigo-900 dark:bg-slate-900 border-r border-indigo-800 dark:border-slate-800 h-full fixed z-30 transition-all text-white shadow-xl">
    <div class="flex items-center h-16 px-6 border-b border-indigo-800 dark:border-slate-800 bg-indigo-950/20">
        <a href="dashboard.php" class="flex items-center text-xl font-bold tracking-tight text-white">
    ...
    <nav class="flex-1 px-4 py-6 space-y-1.5">
        ...
        <a href="profile.php" class="flex items-center px-4 py-2.5 text-indigo-100 dark:text-slate-400 hover:bg-indigo-800/50 dark:hover:bg-slate-800 hover:text-white dark:hover:text-white rounded-xl group transition-all font-medium">
