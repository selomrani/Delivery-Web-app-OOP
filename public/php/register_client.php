...
<head>
    ...
    <title>Sign Up - Client - Swift Drop</title>
    ...
    <div class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-10 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 transition-all duration-300">
            ...
            <div class="text-center">
                ...
                <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Create Client Account</h2>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    Join Swift Drop today
                </p>
            </div>

            <form class="mt-8 space-y-6" action="../Actions/Registerclient.php" method="POST">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div id="role-customer" class="cursor-default relative rounded-xl border-2 border-blue-500 bg-blue-50 dark:bg-blue-900/20 dark:border-blue-500 p-4 flex flex-col items-center justify-center text-center transition-all duration-200">
